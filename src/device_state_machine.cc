...
// Ported verbatim from xiaozhi-esp32 main/device_state_machine.cc; only the
// logging macros differ. The transition table is the contract the application
// relies on, so it is kept identical to upstream.
